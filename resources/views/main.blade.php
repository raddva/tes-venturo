                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            @if (isset($year))
                                ...
                                <a href="http://tes-web.landa.id/intermediate/transaksi?tahun=<?= $year ?>"
                        ...
                        <table class="table table-hover table-bordered" style="margin: 0;">
                            ...
                            <tbody>
                                        ...
                                        @if ($m['kategori'] == 'makanan')
                                            ...
                                            @for ($i = 1; $i <= 12; $i++)
                                                ...
                                                <td style="text-align: right;">
                                                    {{-- <a
                                                        href="{{ route('detail', ['year' => $year, 'month' => $i, 'menu' => $m['menu'], 'transaksi' => json_encode($transaksi)]) }}">
                                                        {{ $mTotal != 0 ? number_format($mTotal) : '' }}
                                                    </a> --}}
                                                    <form action="{{ route('detail', ['year' => $year, 'month' => $i, 'menu' => $m['menu']]) }}" method="POST" style="display: inline;">
                                                        @csrf
                                                        <input type="hidden" name="transaksi" value="{{ json_encode($transaksi) }}">
                                ...
                                <tr class="table-dark">
                                    ...
                                    @endforeach
                                    <td style="text-align: right;">
                                        <b>{{ $sumall != 0 ? number_format($sumall) : 0 }}</b>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
